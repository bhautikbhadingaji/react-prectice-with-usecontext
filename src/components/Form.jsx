...
export const Form = () => {
    ...
    return (
        <div>
            ...
            <Dialog openForm={openForm} onClose={setOpenForm} className="relative z-10">
                <DialogBackdrop
                    transition
                            ...
                            >
                                <TransitionChild>
                                    <div className="absolute top-0 left-0 -ml-8 flex pt-4 pr-2 duration-500 ease-in-out data-closed:opacity-0 sm:-ml-10 sm:pr-4">
                                        <button
                                            ...
                                            className="relative rounded-md text-black focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                                        >
                                ...
                                <div className="relative flex h-full flex-col overflow-y-auto bg-gray-800 py-6 shadow-xl after:absolute after:inset-y-0 after:left-0 after:w-px after:bg-white/10">
                                    <div className="px-4 sm:px-6">
                                        <DialogTitle className="text-base font-semibold text-white">Add Post</DialogTitle>
                                    </div>
